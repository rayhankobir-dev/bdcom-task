...
export default function Dashboard() {
  return (
    <div className="flex flex-col w-full min-h-screen">
      <main className="flex flex-1 flex-col gap-8 p-4 md:gap-10 md:p-10">
        ...
        <div>
          <Card>
            ...
            <CardContent className="flex gap-4">
              <div className="w-fit h-fit flex flex-col gap-2 bg-black rounded-xl overflow-hidden pb-4">
                <div className="w-fit h-32 flex justify-center items-center">
                  <Ram />
                </div>
